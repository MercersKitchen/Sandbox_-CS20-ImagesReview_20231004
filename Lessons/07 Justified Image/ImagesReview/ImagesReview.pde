...
void draw()
{
  ...
  rect(obiX, obiY, obiWidth, obiHeight); //landscape geometry
  rect(darthX, darthY, darthWidth, darthHeight); //portrait geometry
  //NOTE: see ASPECT Ratio for Justification Integer, 0=left, 1=right, 2=centered
  //BUG OPTION, change integer to readable variable
  imageDraw( darthPic, 0, darthPicWidth, darthPicHeight, obiX, obiY, obiWidth, obiHeight );
  //imageDraw( obiPic, 0, obiPicWidth, obiPicHeight, darthX, darthY, darthWidth, darthHeight );
  //
} //End draw
//
void mousePressed() {
